...
let ProductService = class ProductService {
    ...
    createNewProduct(productDto) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.productRepository.save(new product_entity_1.Product(productDto));
            return true;
        });
    }
    ...
    addProductCategory({ productId, categoryId }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.productRepository.findOneAndUpdate({
                _id: mongodb_1.ObjectID(productId)
            }, {
                $push: {
                    categories: {
                        categoryId,
